...
=================================""")
print("""====================================""")
url = input("\033[96m siteyi giriniz ==>    ")
print("                                                                                ")
print("\033[94m Admin-loger aktif edildi  »» ")



print ("                                                                      ")

passte = ('admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for yapıştır in passte :
    nenen = url+yapıştır
    try:
       openurl = urllib.request.urlopen(nenen)
       time.sleep(0.1)
       
       print ("------------------------------------------------------------")
       print ("                                                             ")
       print ("\033[95m Hayırlı olsun bulduk==>  "+nenen)
       print ("------------------------------------------------------------                                                                                                                       ")
    except urllib.error.URLError as msg :
        print ("\033[0;91m panel bulunamadı://")

print ("------------------------------------------------------------------")
print ("                                                                         ")
print ("\033[93m instagram / Alozzers")
print ("------------------------------------------------------------------")
